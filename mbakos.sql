...
INSERT INTO `kos` (`id_kos`, `id_user`, `deskripsi`, `alamat`, `slug`, `date`, `time`, `status`, `lokasi`, `harga_min`, `nama`, `tipe`, `image_header`) VALUES
...
(13, 3, 'Sekamar berdua 1.325.000/bulan. Harga sewa kamar lainnya 1.175.000/ bulan (Ada air panas) atau bila sekamar berdua menjadi 1.575.000/bulan.', 'Jl. Permai No.17 Cigadung Cibeunying Kaler Lokasi Bandung ', 'Kost-Cibeunying-Permai', '2017-06-07', '13:56:15', 1, 'bandung', 700000, 'Kost Cibeunying Permai', 'Putri', 'kos2.jpg'),
...
(43, 16, 'Harga sudah termasuk listrik. Bila sekamar berdua dikenai tambahan 500ribu. Tersedia harga_min 1,6juta (ukuran kamar lebih kecil).', 'Jl. Tubagus Ismanil No.90', 'kost-tipe-a-tubagus-ismail-depan-no-90-bandung', '2017-07-12', '15:53:42', 1, 'Bandung', 950000, 'Kost Tipe A Tubagus Ismail Depan No. 90 Bandung', 'Campur', '12.jpg'),
...
INSERT INTO `user` (`id_user`, `username`, `password`, `fullname`, `jk`, `email`, `no_hp`, `alamat`, `id_role`) VALUES
