                    ...
                    <div class="card">
                        ...
                        <div class="body"> 
                            ...
                            <?php foreach($user as $u){ ?>
                                            <form  method="POST" id="form_edit_user" class="form-horizontal"  action="<?php echo site_url('admin/proses_update_admin')?>">
                                               <input type="hidden" name="id_user" value="<?php echo $u->id_user ?>">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                                        <a href="<?php echo base_url('admin/data_admin')?>"><input type="button" class="btn btn-danger m-t-15 waves-effect" value="Cancel"></a>
