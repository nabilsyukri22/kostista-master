                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="alert alert-success">
                            <strong>HALLO !</strong> <?php echo strtoupper($fullname) ?>, Anda login sebagai <b>Admin</b>. <br>
                            Klik <a href="<?php echo base_url() ?>user"><b>disini</b></a> untuk login sebagai user.
                        </div>
