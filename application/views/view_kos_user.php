                             ...
                             <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <?php foreach ($kos as $k) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $k->jumlah_tersedia; ?></td>
                                        ...
                                        <a href="<?= base_url() ?>user/edit_kos/<?= $k->id_kos ?>"><button type="button" style="width:75px;" class="btn btn-primary waves-effect">Edit</button></a>
                                            
                                        <a onclick="return confirm('Apa anda yakin akan menghapus data kos ini ?')" href="<?php echo base_url('user/delete_kos/'.$k->id_kos)?>">
