                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <?php foreach ($kos as $k) { ?>
                            <form method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo site_url('admin/proses_update_kos') ?>">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="lokasi" value="<?php echo $k->lokasi ?>" id="lokasi" class="form-control" placeholder="Masukan Lokasi" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="harga_min">Harga</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="harga_min" value="<?php echo $k->harga_min ?>" class="form-control" name="harga_min" placeholder="Masukan Harga" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <br>
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <a href="<?php echo base_url('admin/view_kos') ?>">
